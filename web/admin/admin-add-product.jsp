        ...
        <div class="container mt-3" style="text-align: center;">
            ...
            <form action="/admin/catalog/product/add" method="post" enctype="multipart/form-data" class="mt-3">
                <table style="font-size: large" class="table table-borderless">
                    <tr>
                        <td>Tên sách</td>
                        <td><input type="text" name="nameBook" required="" placeholder="Tên sách"></td>
                        <td>Tên tác giả</td>
                        <td><input type="text" name="author" required="" placeholder="Tên tác giả"></td>
                    </tr>
                    <tr>
                        <td>Nhà xuất bản</td>
                        <td><input type="text" name="NXB" required="" placeholder="Nhà xuất bản"></td>
                        <td>Năm xuất bản</td>
                        <td><input type="text" name="dateofissue" required="" placeholder="Năm xuất bản"></td>
                    </tr>
                    <tr>
                        <td>Số trang</td>
                        <td><input type="number" name="numberPage" required="" placeholder="Số trang"></td>
                        <td>Số lượng</td>
