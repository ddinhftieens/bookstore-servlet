...
<html>
    ...
    <body>
        ...
        <div class="container mt-3" style="text-align: center"><img src="/image/product?IDcode=logo" style="width: 580px;height: 180px"/></div>
        ...
        <%
            ...
            List<Product> listBestSale = (List<Product>) request.getAttribute("listBestSale");
            List<Product> listTopSale = (List<Product>) request.getAttribute("listTopSale");
        %>
