    ...
    <body>
        ...
        <form action="/admin/catalog/product/edit?IDcatalog=<%=pro.getIDcatalog()%>" method="post" class="mt-3">
            <table style="font-size: large" class="table table-borderless">
                ...
                <tr>
                    <td>Xuất xứ</td>
                    <td><input type="text" name="nhaxuatban" value="<%= pro.getNXB() %>" required="" placeholder="Xuất xứ"></td>
                    <td>Năm sản xuất</td>
                    <td><input type="text" name="ngayphathanh" value="<%= pro.getDateofissue() %>" required="" placeholder="Năm xuất bản"></td>
                </tr>
                <tr>
                    <td>Dung lượng</td>
                    <td><input type="number" name="sotrang" value="<%= pro.getNumberpage() %>" required="" placeholder="Dung lượng"></td>
                    <td>Số lượng</td>
