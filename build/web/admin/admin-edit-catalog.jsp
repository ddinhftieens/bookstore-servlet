<%-- 
    Document   : admin-edit-catalog
    Created on : Sep 27, 2019, 3:39:13 PM
    Author     : Dell
--%>
...
<html>
    ...
    <body>
        <%
            Catalog cata = (Catalog) request.getAttribute("catalog");
        %>
        <jsp:include page="/admin/admin-home.jsp"></jsp:include>
        <div class="container mt-3" style="text-align: center;">
            <h1>Cập nhật danh mục</h1>
            <form action="/admin/catalog/edit" method="post" class="mt-3">
                <table style="font-size: large" class="table table-borderless">
                    <tr>
                        <td>Tên danh mục</td>
                        <td colspan="3"><input type="text" name="catalog" required="" placeholder="Tên danh mục" value="<%=cata.getNameCatalog()%>"></td>
                    </tr>
                    <tr>
